			...
			<section class="page-section white-section sp-top-bottom100">
				<div class="container sp-top60">
					<div class="offset-by-three thirteen columns" data-sr="enter top over 0.8s and move 140px">
						<form role="form" action="<?=base_url('copublic/do_check')?>" methode="post" enctype="multipart/form-data" accept-charset="utf-8" class="form">
							...
							<div class="clearfix">
								...
								<div class="col col2">
									...
									<div class="form-group">
										<input type="text" required="" pattern=".{3,100}" placeholder="* Input Your Order ID" class="full_width" id="order_id" name="order_id">
									</div>
                                </div>
			...
			<section class="page-section white-section sp-top-bottom100">
				...
				<div class="container sp-top60">
					<div class="offset-by-three thirteen columns" data-sr="enter top over 0.8s and move 140px">
						<form role="form" action="<?=base_url('copublic/do_order')?>" methode="post" enctype="multipart/form-data" accept-charset="utf-8" class="form">
							...
							<div class="clearfix">
								...
								<div class="col col1">
									...
									<div class="form-group">
										<input type="number" required="" pattern=".{3,100}" placeholder="* Phone Number" class="full_width" id="phone" name="phone">
									</div>

									<div class="form-group">                                            
										<textarea required="" placeholder="* Your Address" rows="6" style="height:89px" class="full_width" id="message" name="address"></textarea>
                                    </div>
                                    <div class="form-group">                                            
										<select name="service_id" id="" class="full_width">
									...
									<div class="form-group text-center">
										<input id="f02" name="file_cus" type="file" placeholder="Upload Your Layout" />
